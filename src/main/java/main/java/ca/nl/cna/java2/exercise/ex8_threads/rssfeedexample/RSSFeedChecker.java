package main.java.ca.nl.cna.java2.exercise.ex8_threads.rssfeedexample;
        ...
        try {
            ...
            for (int i = 0; i < itemList.getLength(); i++) {
                ...
                if (itemNode.getNodeType() == Node.ELEMENT_NODE) {
                    ...
                    String creator = itemElement.getElementsByTagName("dc:creator").item(0).getTextContent();
                    String category1 = itemElement.getElementsByTagName("category").item(0).getTextContent();
